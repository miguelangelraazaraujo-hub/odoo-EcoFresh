...
En total quedaría un proyecto de **9 commits** con una progresión muy clara: declarar → relacionar → visualizar → publicar → heredar → productos → lógica → facturar → caja. Cada paso es autocontenido y los alumnos pueden parar en cualquier punto y tener algo funcional.
